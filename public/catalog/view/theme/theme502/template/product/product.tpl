			...
			<div class="<?php echo $content_right; ?> product_page-right">
				...
				<div id="product">
					...
					<div class="form-group form-horizontal">
						...
						<button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-add"><i class="fa fa-shopping-cart"></i><span class="hidden-md"><?php echo $button_cart; ?></span></button>
					</div>

					<ul class="product-buttons">
						<li><button class="btn btn-icon" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i> <span class="hidden-sm"><?php echo $button_wishlist; ?></span></button></li>
						<li><button type="button" class="btn btn-icon" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i> <span class="hidden-sm"><?php echo $button_compare; ?></span></button></li>
					</ul>					
