		...
		<div class="product-layout product-list col-xs-12">
		  <div class="product-thumb">
			...
			<div class="caption">
			  ...
			  <div class="description"><?php echo mb_substr($product['description'],0,80,'UTF-8').'...';?></div>
			  ...
			  <?php } ?>
				...
				<div class="cart-button">					
					...
					<button class="btn btn-add" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i><span class="hidden-md"><?php echo $button_cart; ?></span></button>
				</div>
			  <div class="clear"></div>
		  </div>
		</div>
